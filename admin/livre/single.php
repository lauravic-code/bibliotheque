...
<!-- INCLUDE TOPBAR --> <?php include PATH_ADMIN . "includes/topbar.php" ?>
                ...
                <div class="container-fluid">
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800"><?php echo $livre['titre'] ?></h1>
                    </div>
                </div>

                <div id="card_single">
                    <div class="img_single w-25">
                        <img class="card-img-top" src="<?= URL_ADMIN ."img/cover/".$livre["illustration"] ?>" alt="<?= $livre["illustration"] ?>" >
                    </div>
                ...
                <div class="mb-3 text-center">
                            <a href="<?php echo URL_ADMIN."livre/index.php" ?>" name="btn_retour_index" class=" btn btn-primary">Retour</a>
                        </div>
            </div>
